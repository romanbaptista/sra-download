...
echo
echo "Creating pipeline directories from array: DIRECTORY_ARRAY"
for entry in "${DIRECTORY_ARRAY[@]}"; do
    directory_create "${entry}" || error_exit "Failed to create directory: ${entry}"
done
