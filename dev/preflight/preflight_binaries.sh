...
echo
echo "Checking binaries from array: BINARY_ARRAY"
for entry in "${BINARY_ARRAY[@]}"; do
    tool_check_binary "${entry}" || error_exit "Binary not found: ${entry}"
done
echo "Binaries confirmed"
